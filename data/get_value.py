...
def fund_test():
    ...
    for i in range(len(id)):
        ...
        print(type(fund_name), fund_names[i], current_prices[i], fund_navs[i], jsl_estimate_values[i],
              jsl_discount_rts[i])
    ...
    render = {"tt_res": 1, 'current_price': current_prices[0], "fund_nav": fund_navs[0],
              "jsl_estimate_value": jsl_estimate_values[0], "jsl_discount_rt": jsl_discount_rts[0],
